...
export default function Hero() {
  ...
  return (
    <section className="w-[1220px] mx-auto px-4 py-6 ">
      <div
        className={`relative overflow-hidden rounded-3xl p-8 flex-row h-[400px] flex flex-col  items-center justify-between gap-8 transition-all duration-300 ${
          theme === "dark"
      ...
      >
        <div className="w-[450px]  text-left">
          ...
          <div className="mt-8 flex items-center w-[320px]">
            <div
